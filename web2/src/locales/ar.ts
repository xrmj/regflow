  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'قم بإجراء اختبار استرجاع للتحقق مما إذا كان Aiclona يمكنه استرداد المحتوى المقصود لـ LLM.',
      Parse: 'تحليل',
      dataset: 'مجموعة البيانات',
    ...
    chat: {
      ...
      betaError:
        'يرجى الحصول على مفتاح Aiclona API من صفحة إعدادات النظام أولاً.',
    ...
    setting: {
      ...
      embeddingModelTip:
        'نموذج التضمين الافتراضي لكل قاعدة معرفية تم إنشاؤها حديثًا. إذا لم تتمكن من العثور على نموذج التضمين من القائمة المنسدلة، فتحقق مما إذا كنت تستخدم إصدار Aiclona النحيف (الذي لا يتضمن نماذج التضمين) أو تحقق من https://ragflow.io/docs/dev/supported_models لمعرفة ما إذا كان موفر النموذج الخاص بك يدعم هذا النموذج.',
      img2txtModel: 'VLM',
      img2txtModelTip:
